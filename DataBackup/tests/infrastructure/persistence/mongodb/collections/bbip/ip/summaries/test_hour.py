...
MODULE = "scanbackup.infrastructure.persistence.mongodb.collections.bbip.ip.summaries.hour"


class TestIPHourSummaryBBIPCollectionCreate(unittest.TestCase):
    """Unit tests for IPHourSummaryBBIPCollection.create."""
    ...
    def test_creates_collection_and_indexes(self) -> None:
        ...
        IPHourSummaryBBIPCollection.create(database)
...
class TestIPHourSummaryBBIPCollectionDelete(unittest.TestCase):
    """Unit tests for IPHourSummaryBBIPCollection.delete."""
    ...
    def test_deletes_documents_and_drops_collection(self) -> None:
        ...
        IPHourSummaryBBIPCollection.delete(database)
...
class TestIPHourSummaryBBIPCollectionExportData(unittest.TestCase):
    """Unit tests for IPHourSummaryBBIPCollection.export_data."""
    ...
    def test_returns_the_writer_filepath(self, mock_writer_cls) -> None:
        ...
        result = IPHourSummaryBBIPCollection.export_data(database)
    ...
    def test_passes_dirpath_to_the_writer(self, mock_writer_cls) -> None:
        ...
        IPHourSummaryBBIPCollection.export_data(database, dirpath=Path("/tmp/out"))

        mock_writer_cls.assert_called_once_with(dir=Path("/tmp/out"))


class TestIPHourSummaryBBIPCollectionImportData(unittest.TestCase):
    """Unit tests for IPHourSummaryBBIPCollection.import_data."""

    @patch(f"{MODULE}.IPHourSummaryBBIPImport")
    def test_inserts_documents_from_reader(self, mock_reader_cls) -> None:
        ...
        IPHourSummaryBBIPCollection.import_data(database, "/tmp/in.csv", ";")
