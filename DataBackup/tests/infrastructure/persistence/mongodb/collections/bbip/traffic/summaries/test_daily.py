...
MODULE = (
    "scanbackup.infrastructure.persistence.mongodb.collections.bbip.traffic.summaries.daily"
)


class TestTrafficDailySummaryBBIPCollectionCreate(unittest.TestCase):
    """Unit tests for TrafficDailySummaryBBIPCollection.create."""
    ...
    def test_creates_collection_and_indexes(self) -> None:
        ...
        TrafficDailySummaryBBIPCollection.create(database)
...
class TestTrafficDailySummaryBBIPCollectionDelete(unittest.TestCase):
    """Unit tests for TrafficDailySummaryBBIPCollection.delete."""
    ...
    def test_deletes_documents_and_drops_collection(self) -> None:
        ...
        TrafficDailySummaryBBIPCollection.delete(database)
...
class TestTrafficDailySummaryBBIPCollectionExportData(unittest.TestCase):
    """Unit tests for TrafficDailySummaryBBIPCollection.export_data."""
    ...
    def test_returns_the_writer_filepath(self, mock_writer_cls) -> None:
        ...
        result = TrafficDailySummaryBBIPCollection.export_data(database)
...
class TestTrafficDailySummaryBBIPCollectionImportData(unittest.TestCase):
    ...
    @patch(f"{MODULE}.TrafficDailySummaryBBIPImport")
    def test_inserts_documents_from_reader(self, mock_reader_cls) -> None:
        ...
        TrafficDailySummaryBBIPCollection.import_data(database, "/tmp/in.csv", ";")
