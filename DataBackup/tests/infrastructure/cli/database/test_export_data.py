...
MODULE = "scanbackup.infrastructure.cli.database.export_data"
...
class TestExportDataFromDatabase(unittest.TestCase):
    ...
    @patch(f"{MODULE}.DatabaseExportUseCase")
    ...
    def test_reports_the_exported_filepath(
        ...
        """The final message must include the filepath returned by the use case."""
        cfg_db = MagicMock()
        ...
        use_case = MagicMock()
        use_case.execute.return_value = "/tmp/out.csv"
