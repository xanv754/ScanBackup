...
class TestTrafficSummaryGeneratorUseCase(unittest.TestCase):
    """Unit tests for the TrafficSummaryGeneratorUseCase."""
    ...
    def _build_use_case(self, layers: list[str]) -> TrafficSummaryGeneratorUseCase:
        """Build a use case instance sharing this test's mocked collaborators."""
        return TrafficSummaryGeneratorUseCase(
