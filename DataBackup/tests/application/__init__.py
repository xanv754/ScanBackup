...
# `scanbackup.application.cli.sources.updater` imports the external `sources_scrapper`
# package, which is not an installed dependency of this project. Any test that
# transitively imports `scanbackup.application` (its __init__ eagerly wires the whole
...
# `scanbackup.application` tree importable for testing.
