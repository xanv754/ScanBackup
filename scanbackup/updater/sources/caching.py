    ...
    def get_sources(self, html: BeautifulSoup) -> list[Source]:
        ...
        def get_services(page: BeautifulSoup) -> list[tuple[str, str]]:
            ...
            blocks = (
                ...
                .find("nav", class_="mt-2")
                .find("ul", class_="nav nav-pills nav-sidebar flex-column")
                .find("li", class_="nav-item menu-open")
                .find("ul", class_="nav nav-treeview")
                .find_all("li", class_="nav-item")
            )
            del blocks[0]
            for item in blocks:
                ...
                if self._SERVICE_SPECIAL in service:
                    service = self._SERVICE_SPECIAL_TRANSFORM
        ...
        for interface in interfaces:
            ...
            if not page:
                continue
            blocks = (
                page.find("section", class_="content")
                .find("div", class_="row")
            ...
            for item in blocks:
                ...
                if JUNK_WORD in name_interface:
                    continue
