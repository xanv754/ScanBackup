...
class BBIPCollection:
    ...
    def create(name_collection: MongoCollectionName, database: Database) -> None:
        try:
            ...
            raise CreateCollectionMongoError(
                name_collection.value,
                error=f"La colección no es válida para creación\n{error}",
            )
        except Exception as error:
            raise CreateCollectionMongoError(name_collection.value, error=error)
    ...
    def delete(name_collection: MongoCollectionName, database: Database) -> None:
        try:
            ...
            raise DeleteCollectionMongoError(name_collection, error=error)
    ...
    def export_data(
        ...
        try:
            ...
            raise ExportCollectionMongoError(name_collection.value, error=error)
    ...
    def import_data(
        ...
        try:
            ...
            raise ImportCollectionMongoError(name_collection.value, error=error)
